...
- **Timing**:
  - Un coffre apparait toutes les 30 minutes des qu'un joueur est connecte
...
- Quand un joueur rejoint, le timer de 30 minutes demarre silencieusement
- Un coffre apparait toutes les 30 minutes
